...
Prefer small modules with clear ownership. If a feature spans multiple files, group it under a named subdirectory such as `src/keybindings/` or `src/platform/`.
